...
OBJS=amazon.o user.o db_parser.o product.o product_parser.o util.o book.o clothing.o movie.o functionaldatastore.o
...
functionaldatastore.o: functionaldatastore.cpp functionaldatastore.h datastore.h product.h user.h
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c functionaldatastore.cpp
